...
namespace Both_Alexandra_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Both_Alexandra_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Both_Alexandra_Lab2Context context,
